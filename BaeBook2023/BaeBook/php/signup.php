...
if(isset($_POST['fname']) && 
   ...
   isset($_POST['pass'])){
    ...
    if (empty($fname)) {
    	...
    	header("Location: ../main/loginsignup.php=$em&$data");
	    exit;
    
    }else if(empty($pass)){
    	$em = "Password is required";
    	header("Location: ../main/loginsignup.phperror=$em&$data");
	    exit;
    }else {
      ...
      if (isset($_FILES['pp']['name']) AND !empty($_FILES['pp']['name'])) {
         ...
         if($error === 0){
            ...
            if(in_array($img_ex_to_lc, $allowed_exs)){
               ...
               header("Location: ../main/loginsignup.php?success=Your account has been created successfully");
                exit;
            }else {
