...
<head>
    ...
    <title>Premium Pink Subscription</title>
...
<body>
    <div class="con">
        <h1>Premium Pink Subscription</h1>

        <div class="bronze" id="#">
            <form action="preceipt.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="hours" placeholder="$500 / hr" min="1" max="12" required>
                </div>
